...
@section('caption', 'Add Districtzone')

@section('title', 'Add Districtzone')
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            {{ Form::open(['route' => 'processStoreDistrictzone']) }}
                        ...
                        <div class="col-lg-12 validate_form">
                            {{ Form::submit('Add Districtzone', ['class' => 'btn btn-primary']) }}
                        </div>
                    {{ Form::close() }}
                    </div>
                </div>
