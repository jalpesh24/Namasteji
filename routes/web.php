...
Route::group(['prefix' => 'countryzone'], function () {
    Route::get('/', 'CRM\CountryzoneController@processListOfCountryzone')->name('countryzone');
    Route::get('form/create', 'CRM\CountryzoneController@processRenderCreateForm')->name('processRenderCreateForm');
    Route::get('form/update/{clientId}', 'CRM\CountryzoneController@processRenderUpdateForm')->name('processRenderUpdateForm');
    Route::get('view/{clientId}', 'CRM\CountryzoneController@processShowCountryzoneDetails')->name('viewCountryzoneDetails');
    Route::post('store', 'CRM\CountryzoneController@processStoreCountryzone')->name('processStoreCountryzone');
    Route::put('update/{employeeId}', 'CRM\CountryzoneController@processUpdateCountryzone')->name('processUpdateCountryzone');
    Route::delete('delete/{clientId}', 'CRM\CountryzoneController@processDeleteCountryzone')->name('processDeleteCountryzone');
